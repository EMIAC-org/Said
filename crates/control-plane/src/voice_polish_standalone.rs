...
/// Standalone server-runtime polish path: format the transcript, then return the
...
/// prompt. The persona-lab harness receives the provider output unchanged.
