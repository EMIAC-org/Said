...
fn is_email_stop_word(word: &str) -> bool {
    ...
    matches!(
        w.as_str(),
        "mail" | "email" | "e-mail" | "send" | "to" | "ping" | "drop" | "shoot" | "forward"
            | "fwd" | "cc" | "bcc" | "write" | "message" | "from" | "reply" | "is" | "my"
            | "his" | "her" | "the" | "an" | "and" | "or" | "for" | "in" | "on" | "of"
            | "that" | "this" | "with" | "it" | "its" | "but" | "not" | "are" | "was"
            | "were" | "will" | "can" | "do" | "did" | "has" | "have" | "had" | "been"
            | "be" | "so" | "if" | "as" | "at" | "by" | "no" | "yes" | "also" | "all"
            | "get" | "got" | "just" | "now" | "here" | "there" | "then" | "than"
            | "too" | "very" | "only" | "how" | "what" | "when" | "where" | "who"
            | "why" | "which" | "would" | "could" | "should" | "may" | "might"
            | "must" | "shall" | "ko" | "ka" | "ki" | "ke" | "hai" | "ho" | "hain"
            | "tha" | "thi" | "kya" | "kaise" | "kab" | "par" | "se" | "ne" | "bhi"
            | "toh" | "aur" | "lekin" | "yaar" | "bhai" | "mein" | "main" | "hum"
            | "tum" | "woh" | "yeh" | "ye" | "ab" | "jab" | "tab" | "sab" | "kuch"
            | "bahut" | "bohot" | "nahi" | "na" | "mat" | "kar" | "karo" | "karna"
            | "hona" | "wahan" | "yahan" | "pata" | "chal" | "jaao" | "jao" | "isko"
            | "usko" | "apna" | "apne" | "apni" | "unka" | "uska" | "iski" | "inhe"
            | "unhe" | "mera" | "tera" | "tumhara" | "hamara" | "diya" | "hua"
            | "liya" | "dena" | "lena" | "raha" | "rahe" | "rahi" | "ek" | "teen"
