...
pub fn on_pipeline_done(ep: &BackendEndpoint, run_id: &str, t: PipelineTelemetry) {
    ...
    let patch = api::TelemetryRunPatch {
        ...
        used_ws_pretranscript: Some(t.used_ws_pretranscript),
        used_http_stt_fallback: Some(t.used_http_stt_fallback),
        stt_provider: Some(t.stt_provider),
        stt_model: Some(t.stt_model),
        stt_path: Some(t.stt_path),
