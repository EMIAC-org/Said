// Official Lark / Feishu brand mark (the three-tone bird), cropped to the bird
// only — the wordmark is dropped. Used on the "Sign in with Lark" workspace card
// and the "Continue with Lark" button (nominative use for the OAuth integration).
// Source paths: Lark official logo. viewBox cropped to the bird's bounding box.

export function LarkLogo({ size = 32 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 34.2 25.37"
      fill="none"
