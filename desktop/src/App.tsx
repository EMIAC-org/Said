  ...
  useEffect(() => {
    ...
    const refreshPending = async () => {
      ...
      if (fresh.length > 0) {
        ...
        sendNotification(
          "AutoNote noticed an edit — tap to review",
          `"${ai}"  →  "${kept}"`
        );
      }
    };
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-[12px] text-muted-foreground">Starting AutoNote…</span>
        </div>
      </div>
    );
  }
        ...
        >
          ...
          <div className="flex flex-col items-center gap-2.5 mb-5">
            ...
            <div className="text-center">
              ...
              >
                {authMode === "login" ? "Welcome back" : "Welcome to AutoNote"}
              </h1>
